...
export const DUMMY = {
  patient: [{ email: 'user@doctormitra.com', password: 'User@123' }],
  doctor: [{ email: 'doctor@doctormitra.com', password: 'Doctor@123' }],
  compounder: [{ email: 'compounder@doctormitra.com', password: 'Compounder@123' }],
  clinic: [
    { email: 'clinic@doctormitra.com', password: 'Clinic@123' },
...
export const AUTH_ROLES = {
  ...
  compounder: {
    key: 'compounder',
    redirect: '/compounder-dashboard',
    brand: {
      title: 'Support every patient, efficiently',
      subtitle: 'Manage queues, patient vitals, prescriptions and clinic tasks.',
      benefits: [
        { icon: ListChecks, title: 'Queue coordination', desc: 'Keep patient flow accurate and up to date.' },
        { icon: HeartPulse, title: 'Clinical records', desc: 'Record vitals and support doctor consultations.' },
        { icon: PackageCheck, title: 'Medicine workflow', desc: 'Track prescriptions and dispensed medicines.' },
      ],
    },
    login: {
      title: 'Compounder Login',
      subtitle: 'Sign in to manage clinic queues, patients and clinical tasks.',
    },
    signup: {
      title: 'Create compounder account',
      subtitle: 'Register as clinic staff to access the compounder workspace.',
    },
  },
}
