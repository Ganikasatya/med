...
const STEPS = [
  ...
  { n: 2, title: 'Owner / Doctor Details', sub: 'Information about the owner' },
      ...
      <main className="mx-auto max-w-[1400px] px-6 py-7">
        ...
        <form onSubmit={handleSubmit} className="mt-4">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 2xl:grid-cols-4">
            ...
            {/* 2. Owner / Doctor Details */}
            <SectionCard icon={UsersRound} title="Owner / Doctor Details">
              <TextInput label="Owner / Doctor Name" required icon={User} placeholder="Enter full name" value={form.ownerName || ''} onChange={set('ownerName')} error={errors.ownerName} />
          ...
          <div className="mt-6 flex justify-center">
            <button className="flex items-center gap-2 rounded-xl bg-brand-blue px-10 py-3.5 text-sm font-semibold text-white shadow-card transition-colors hover:bg-brand-blueDark">
          ...
          {done && (
            <div className="mt-5 flex flex-col items-center justify-between gap-4 rounded-2xl border border-green-200 bg-green-50 p-5 sm:flex-row">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-brand-navy">Once submitted, our team will verify your details.</p>
                  <p className="text-[13px] text-slate-500">You will get notified via email and SMS.</p>
                </div>
              </div>
              <button
                type="button"
