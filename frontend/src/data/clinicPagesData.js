...
export const CLINIC_NAV = [
  ...
  { label: 'Departments', to: '/clinic-dashboard/departments', icon: 'Building2' },
  { label: 'Staff', to: '/clinic-dashboard/staff', icon: 'UserCog' },
  { label: 'Availability', to: '/clinic-dashboard/availability', icon: 'Clock' },
  { label: 'Reports', to: '/clinic-dashboard/reports', icon: 'BarChart3' },
  { label: 'Clinic Profile', to: '/clinic-dashboard/profile', icon: 'Settings' },
]
