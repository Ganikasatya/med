...
export const KPIS = [
  ...
  { value: '18', label: "Today's Token", icon: Ticket, tone: 'green' },
...
export const DOCTORS_LIST = [
  ...
  { name: 'Dr. Rahul Sharma', specialty: 'General Physician', clinic: 'City Care Clinic', location: 'Bengaluru', rating: 4.8, reviews: 290, fee: 500, experience: '12 yrs', status: 'Available' },
...
export const CLINICS_LIST = [
  ...
  { name: 'City Care Clinic', location: 'Bengaluru, Karnataka', doctors: 8, timings: '9:00 AM – 9:00 PM', status: 'Open' },
