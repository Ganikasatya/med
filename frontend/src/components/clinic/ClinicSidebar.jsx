    ...
    <aside className="flex h-full w-64 shrink-0 flex-col border-r border-slate-100 bg-white">
      ...
      <nav className="flex-1 space-y-1 px-3">
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-slate-600 transition-colors hover:bg-red-50 hover:text-red-500"
        >
