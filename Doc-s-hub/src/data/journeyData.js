...
export const LANGUAGES_INFO = [
  { lang: 'English', sub: 'Simple. Easy.', tone: 'green' },
  { lang: 'हिंदी', sub: 'आसान और सुविधाजनक', tone: 'blue' },
  { lang: 'తెలుగు', sub: 'సులభం. సౌకర్యవంతం.', tone: 'orange' },
]

/** Bottom trust strip. `icon` is resolved in the page. */
export const TRUST = [
  { icon: 'ShieldCheck', text: 'Trusted by lakhs of patients.' },
  { icon: 'Heart', text: 'Save time.' },
  { icon: 'Users', text: 'Avoid long waits.' },
  { icon: 'Smile', text: 'Focus on what matters — your health.' },
]
